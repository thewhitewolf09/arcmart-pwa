...
export default function TopUpWallet() {
  ...
  const packages = [
    { id: 1, leads: 10, amount: 490, popular: false },
    { id: 2, leads: 20, amount: 980, popular: true, bonus: '2 Free Leads' },
    { id: 3, leads: 50, amount: 2450, popular: false, bonus: '5 Free Leads' },
  ];
        ...
        <div className="flex items-center justify-between bg-surface-variant/50 border border-outline-variant rounded-2xl p-4">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="font-black text-on-surface text-lg">₹147</p>
            </div>
          </div>
        </div>
