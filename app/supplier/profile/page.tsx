  ...
  return (
    <div className="flex-1 flex flex-col p-5 pb-24 bg-surface min-h-screen">
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <Link
          href="/supplier/profile/verification"
          className="mt-1 flex items-center hover:bg-surface-variant px-2 py-0.5 rounded transition"
        >
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <div className="glass-card rounded-2xl p-4 border border-outline-variant shadow-sm">
            ...
            <Link
              href="/supplier/profile/categories"
              className="w-full py-3 rounded-xl border border-dashed border-outline-variant text-on-surface-variant font-bold text-sm hover:bg-surface-variant hover:text-on-surface transition flex justify-center"
            >
              + Edit Categories
            </Link>
          </div>
        ...
        <section>
          ...
          <div className="glass-card rounded-2xl p-4 border border-outline-variant shadow-sm">
            <div className="flex flex-wrap gap-2 mb-4">
              <span className="px-3 py-1.5 rounded-lg text-xs font-bold bg-secondary-container text-on-secondary-container border border-secondary-container">
                Noida
              </span>
              <span className="px-3 py-1.5 rounded-lg text-xs font-bold bg-secondary-container text-on-secondary-container border border-secondary-container">
                Greater Noida
          ...
          <div className="glass-card rounded-2xl p-4 border border-outline-variant shadow-sm">
            <div className="grid grid-cols-3 gap-2 mb-4">
              {[1, 2].map((i) => (
                <div
                  key={i}
                  className="aspect-square rounded-xl bg-secondary-container border border-outline-variant flex items-center justify-center"
                >
              ...
              <Link
                ...
                className="aspect-square rounded-xl border-2 border-dashed border-outline-variant flex flex-col items-center justify-center text-on-surface-variant hover:bg-surface-variant transition"
              >
            ...
            <Link
              href="/supplier/profile/photos"
              className="w-full py-3 rounded-xl bg-surface-variant text-on-surface font-bold text-sm flex justify-center items-center hover:bg-outline-variant transition"
            >
              Manage All Photos
            </Link>
          </div>
        ...
        <section>
          ...
          <Link
            href="/supplier/profile/delivery"
            className="glass-card rounded-2xl p-4 border border-outline-variant shadow-sm flex items-center justify-between hover:bg-surface-variant transition"
          >
            <div className="flex items-center">
        ...
        <section>
          ...
          {/* Certificates (SUP-43) */}
          <Link
            href="/supplier/profile/certificates"
            className="glass-card rounded-2xl p-4 border border-outline-variant shadow-sm flex items-center justify-between hover:bg-surface-variant transition mt-4"
          >
            <div className="flex items-center">
        ...
        <section>
          ...
          <Link
            ...
            className="glass-card rounded-2xl p-4 border border-outline-variant shadow-sm flex items-center justify-between hover:bg-surface-variant transition mb-4"
          >
            <div className="flex items-center">
            ...
            >
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-yellow-600 font-bold uppercase tracking-wider">
                    Rank #2 in Tiles
                  </p>
                </div>
              </div>
        ...
        <section className="pt-4 border-t border-outline-variant">
          <Link
            href="/supplier/profile/delete"
            className="flex items-center justify-center p-4 text-error font-bold text-sm hover:bg-error/5 rounded-xl transition"
          >
